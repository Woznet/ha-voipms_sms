...
voipms_sms:
  ...
  sender_did: !secret voipms_sender_did
```
...
```yaml
voipms_user: 'my@email.com'
voipms_api_password: 'xxxxxxxxxxx'
voipms_sender_did: '5714561013'
```
...
![alt text](assets/custom-integration.png)
...
![alt text](assets/developer-tools.png)
